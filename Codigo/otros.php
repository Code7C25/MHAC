...
<head>
    ...
    <title>Otros Animales en Adopción - MHAC</title>
...
<body>
    ...
    <header>
        <h1>Otros Animales en Adopción</h1>
    </header>
        ...
        <section class="mascotas-grid">
                        ...
                        <div class="mascota-card">
                            <?php if (!empty($m['foto'])): ?>
                                <div class="mascota-imagen">
                                    ...
                                    <div class="mascota-badge">
                                        <?php if ((int)$m['dias_en_mhac'] <= 7): ?>
                                            <span class="badge nuevo">NUEVO</span>
                                        <?php elseif ((int)$m['dias_en_mhac'] > 60): ?>
                            ...
                            <div class="mascota-info">
                                ...
                                <div class="info-adicional">
                                    ...
                                    <p><strong>Días en MHAC:</strong> <?= (int)$m['dias_en_mhac'] ?> días</p>
                                </div>
                            </div>
                        </div>
                    <?php endwhile; ?>
            ...
            <?php else: ?>
                <div class="sin-resultados">
                    <p>No hay otros animales disponibles en adopción en este momento.</p>
                </div>
            <?php endif; ?>
        </section>
    </main>
