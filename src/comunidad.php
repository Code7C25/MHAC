    ...
    if (moderar_texto($contenido)) {
        ...
        if (!empty($_FILES['imagen']['name'])) {
            ...
            if (move_uploaded_file($_FILES['imagen']['tmp_name'], $rutaCompleta)) {
                ...
                $rutaImagen = "../assets/imagenes/" . $nombreArchivo;
            }
        }
  ...
  <?php foreach ($posts as $post): ?>
    <article class="post">
      ...
      <?php if ($post['imagen']): 
        $rutaImg = $post['imagen'];
        if (!strpos($rutaImg, '/')) {
          if (file_exists('../assets/imagenes/' . $rutaImg)) {
            $rutaImg = '../assets/imagenes/' . $rutaImg;
          } elseif (file_exists('../assets/uploads/' . $rutaImg)) {
            $rutaImg = '../assets/uploads/' . $rutaImg;
          }
        }
      ?>
